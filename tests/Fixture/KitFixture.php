 ...
 *
 */
class KitFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'image' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => 'no_image.png', 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'status' => ['type' => 'string', 'length' => null, 'null' => false, 'default' => 'b\'0\'', 'collate' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'kit_slug_uindex' => ['type' => 'unique', 'columns' => ['slug'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            'id' => '61e33e2d-8217-4c6d-8ee1-c9a10ced12bc',
