...
?>
    ...
    <h3>Normal ACOs</h3>
<?= $this->element('Admin/ACL_sub', ['acls' => $normal_acls, 'test' => $acls, 'Form' => $Form, 'disabled' => $disabled]) ?>

    <h3>Admin ACOs</h3>
<?= $this->element('Admin/ACL_sub', ['acls' => $admin_acls, 'test' => $acls, 'Form' => $Form, 'disabled' => $disabled]) ?>